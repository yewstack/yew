...
The [`ssr_router` example](https://github.com/yewstack/yew/blob/yew-v0.22.1/examples/ssr_router/src/bin/ssr_router_server.rs) demonstrates this pattern: the server recognizes the
...
Example: [simple_ssr](https://github.com/yewstack/yew/tree/yew-v0.22.1/examples/simple_ssr)
Example: [ssr_router](https://github.com/yewstack/yew/tree/yew-v0.22.1/examples/ssr_router)
...
Example: [wasi_ssr_module](https://github.com/yewstack/yew/tree/yew-v0.22.1/examples/wasi_ssr_module)
