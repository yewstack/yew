...
> The configuration below works with any version of Neovim, add the following to where your `lspconfig` exists, this needs the `emmet_ls` server to be installed with lsp:

```lua
local function setup_emmet_rs()
