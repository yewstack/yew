...
When getting started, we recommend using [Trunk](https://trunk-rs.github.io/trunk/). Trunk is a Wasm web application
bundler for Rust.
...
:::important
The minimum supported Rust version (MSRV) for Yew is `1.85.0`. Older versions will not compile.
...
# See https://trunk-rs.github.io/trunk/guide/getting-started/installation.html for further details
