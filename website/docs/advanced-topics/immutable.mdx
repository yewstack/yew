...
In a React-like framework, properties a propagated from ancestors to children.
This means that the properties must live when each component update happens.
This is why properties should -ideally- be cheap to clone. In order to achieve
this we usually wrap things in `Rc`.
...
impl Component for ArrayExample {
    ...
    fn update(&mut self, _: &Context<Self>, msg: Self::Message) -> bool {
        match msg {
	    	...
	    	// A new IArray is created with all the elements of the previous one
