...
sometimes rely on calling Javascript.
What follows is an overview of the involved libraries, a detailed description can be found in the
[Javascript with Rust](../wasm-bindgen) section.
...
We highly recommend you take a look at their [documentation](https://rustwasm.github.io/docs/wasm-bindgen/)
...
Once again we highly recommend you take a look at their [documentation](https://rustwasm.github.io/docs/wasm-bindgen/).
