...
接下来我们需要更新 `App` 组件，让它能够获取数据。现代 Yew 的做法是使用 [`use_future`](https://docs.rs/yew/0.23.0/yew/suspense/fn.use_future.html) 和 [`<Suspense>`](https://yew.rs/docs/concepts/suspense)。
