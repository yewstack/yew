...
接著我們需要更新 `App` 元件，讓它能擷取資料。現代 Yew 的作法是使用 [`use_future`](https://docs.rs/yew/0.23.0/yew/suspense/fn.use_future.html) 與 [`<Suspense>`](https://yew.rs/docs/concepts/suspense)。
