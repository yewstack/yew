...
async fn hydration_nested_suspense_works() {
    ...
    assert_eq!(
        result.as_str(),
        r#"<!--<[yew::functional::FunctionComponent<hydration::hydration_nested_suspense_works::{{closure}}::ContentFunctionProvider>]>--><div class="content-area"><div class="action-area"><button class="take-a-break">Take a break!</button></div><!--<[yew::suspense::component::Suspense]>--><!--<[yew::suspense::component::BaseSuspense]>--><!--<?>--><!--<[yew::functional::FunctionComponent<hydration::hydration_nested_suspense_works::{{closure}}::InnerContentFunctionProvider>]>--><div class="content-area"><div class="action-area"><button class="take-a-break2">Take a break!</button></div></div><!--</[yew::functional::FunctionComponent<hydration::hydration_nested_suspense_works::{{closure}}::InnerContentFunctionProvider>]>--><!--</?>--><!--</[yew::suspense::component::BaseSuspense]>--><!--</[yew::suspense::component::Suspense]>--></div><!--</[yew::functional::FunctionComponent<hydration::hydration_nested_suspense_works::{{closure}}::ContentFunctionProvider>]>-->"#
    );
