...
async fn use_transitive_state_works() {
    ...
    assert_eq!(
        ...
        r#"<!--<[use_transitive_state::use_transitive_state_works::{{closure}}::App]>--><div><!--<[use_transitive_state::use_transitive_state_works::{{closure}}::Comp]>--><div>0</div><script type="application/x-yew-comp-state">ATkwAAAB</script><!--</[use_transitive_state::use_transitive_state_works::{{closure}}::Comp]>--></div><!--</[use_transitive_state::use_transitive_state_works::{{closure}}::App]>-->"#
    );
