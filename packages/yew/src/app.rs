    ...
    COMP::Properties: Default,
{
    ...
    pub fn mount(element: Element) -> Self {
        clear_element(&element);
        Self::mount_with_props(element, COMP::Properties::default())
    }
    ...
    pub fn mount_as_body() -> Self {
        ...
        Self::mount_with_props(html_element, COMP::Properties::default())
    }
}
    ...
    COMP: Component,
{
    ...
    pub fn mount_with_props(element: Element, props: COMP::Properties) -> Self {
        clear_element(&element);
        let app = Self::new();
        app.scope
    ...
    pub fn mount_to_body_with_props(props: COMP::Properties) -> Self {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
    ...
    /// CSS classes of the body element.
    pub fn mount_as_body_with_props(props: COMP::Properties) -> Self {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
