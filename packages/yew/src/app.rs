    ...
    COMP::Properties: Default,
{
    ...
    pub fn mount(mut self, element: Element) -> Self {
        clear_element(&element);
        self.scope = self.scope.mount_in_place(
            element,
            NodeRef::default(),
            NodeRef::default(),
            COMP::Properties::default(),
    ...
    /// Alias to `mount("body", ...)`.
    pub fn mount_to_body(self) -> Self {
    ...
    pub fn mount_as_body(mut self) -> Self {
    ...
    COMP: Component,
{
    ...
    pub fn mount_with_props(mut self, element: Element, props: COMP::Properties) -> Self {
        clear_element(&element);
        self.scope =
            self.scope
    ...
    pub fn mount_to_body_with_props(self, props: COMP::Properties) -> Self {
        // Bootstrap the component for `Window` environment only (not for `Worker`)
        let element = document()
            .query_selector("body")
            .expect("can't get body node for rendering")
    ...
    /// CSS classes of the body element.
    pub fn mount_as_body_with_props(mut self, props: COMP::Properties) -> Self {
        let html_element = document()
            .query_selector("html")
            .expect("can't get html node for rendering")
            .expect("can't unwrap html node");
