...
| `onchange` | [ChangeData](https://docs.rs/web-sys/latest/web_sys/struct.ChangeData.html) | [ChangeEvent](https://docs.rs/stdweb/latest/stdweb/web/event/struct.ChangeEvent.html) |
...
| `oninput` | [ChangeData](https://docs.rs/web-sys/latest/web_sys/struct.ChangeData.html) | [InputEvent](https://docs.rs/stdweb/latest/stdweb/web/event/struct.InputEvent.html) |
