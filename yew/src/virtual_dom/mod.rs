...
mod listener {
    ...
    pub trait Listener<REND: DomBackend> {
        /// Returns the name of the event
        fn kind(&self) -> &'static str;
        /// Attaches a listener to the element.
        fn attach(&self, element: &REND::Element) -> REND::EventListener;
    }
...
mod vdiff {
    ...
    pub(crate) trait VDiff<REND: DomBackend> {
...
fn insert_node<REND: DomBackend>(
    node: &REND::Node,
    parent: &REND::Element,
    next_sibling: Option<REND::Node>,
) {
