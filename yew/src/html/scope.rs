...
pub use anyscope::AnyScope;
pub use messaging::SendAsMessage;
pub use scoped::Scope;
pub(crate) use scoped::Scoped;

pub(crate) use messaging::ComponentState;
...
mod messaging {
    ...
    /// it.
    pub(crate) struct CreateComponent<COMP>
    where
        COMP: Component,
    {
        state: Shared<Option<ComponentState<COMP>>>,
    ...
    pub(crate) struct UpdateComponent<COMP>
    where
        COMP: Component,
    {
        state: Shared<Option<ComponentState<COMP>>>,
    ...
    pub(crate) struct RenderComponent<COMP>
    where
        COMP: Component,
    {
        state: Shared<Option<ComponentState<COMP>>>,
    ...
    pub(crate) struct RenderedComponent<COMP>
    where
        COMP: Component,
    {
        state: Shared<Option<ComponentState<COMP>>>,
    ...
    pub(crate) struct DestroyComponent<COMP>
    where
        COMP: Component,
    {
        state: Shared<Option<ComponentState<COMP>>>,
