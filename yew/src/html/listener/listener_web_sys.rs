...
impl_action! {
    ...
    ondragexit(name: "dragexit", event: MouseEvent) -> web_sys::MouseEvent => |_, event| { event }
    ondragleave(name: "dragleave", event: MouseEvent) -> web_sys::MouseEvent => |_, event| { event }
    ondragover(name: "dragover", event: MouseEvent) -> web_sys::MouseEvent => |_, event| { event }
    ondragstart(name: "dragstart", event: MouseEvent) -> web_sys::MouseEvent => |_, event| { event }
    ondrop(name: "drop", event: MouseEvent) -> web_sys::MouseEvent => |_, event| { event }
    ...
    onresize(name: "resize", event: UiEvent) -> web_sys::UiEvent => |_, event| { event }
