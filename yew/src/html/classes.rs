...
/// A set of classes. The use of `classes!` is preferred.
...
mod macro_tests {
    ...
    fn filter_empty_string_classes() {
        let b_empty_string_1 = "".to_string();
        let b_empty_string_2 = "".to_string();
        let a = html! { <div class=classes!(vec![""])></div> };
        let b = html! { <div class=classes!(b_empty_string_1, b_empty_string_2)></div> };
