    ...
    Content::new(vec![
        ...
        p![
            ...
            " macro 会将使用类似 HTML 的自定义语法编写的代码转换为有效的 Rust \
             ...
             API，如果你愿意的话，可以直接使用。请注意，有些方法是有意未记录的，以避免意外的误用。\
             随着 ",
            code("yew-macro"),
            " 的每次更新，生成的代码将会更加高效，并且可以处理任何破坏性的更改，而不需要对 ",
            code("html!"),
            " 语法进行很多（如果有的话）修改。",
        ],
        p![
        ...
        ol![
            ...
            li![
                "由于可能存在 trait 方法名称冲突，使用 ",
                code("<Type as Trait>"),
                " 来确保我们使用的是正确的 trait 成员。",
            ],
        ],
        h2!["什么是虚拟 DOM？"],
        p![
