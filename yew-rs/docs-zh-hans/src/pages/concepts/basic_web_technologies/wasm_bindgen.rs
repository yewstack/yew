...
log_many("Logging", "many values!");"#,
        ...
        p![
            text("一个常见的例子是在 "),
            link!("/zh-Hans/docs/concepts/basic-web-technologies/web-sys", text("web-sys")),
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p![
            ...
            code("Closure"),
            text("。在 "),
            link!("/zh-Hans/docs/concepts/html/events", text("Events")),
            text(" 页面的 "),
            link!("/zh-Hans/docs/concepts/html/events#using-closure-verbose", text("Using Closure 部分")),
            text(" 中可以找到在 Yew 中使用 "),
            code("Closure"),
            text(" 的示例。"),
        ],
