pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        ol![
            ...
            li![text("选择 Rust 并点击 + 图标添加新的 Live Template。",)],
            li![text("根据需要给它一个的名称和描述。")],
            li![text("将以下代码片段粘贴到模板文本部分。")],
            li![text("在右下角更改适用性，选择 Rust > Item > Module")],
        ],
        p![text("对于函数式组件，使用以下模板。")],
        ul![li![
            text("(可选) 点击编辑变量，并给 "),
            code("tag"),
...
impl Component for $NAME$ {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        h3![text("VS Code")],
        ol![
            li![text("从导航栏依次点击 File > Preferences > User Snippets.",)],
            li![text("选择 Rust 作为设置语言。")],
            li![text("在 JSON 文件中添加以下代码片段：")],
        ],
        code_block(
            "json",
            r##"{
    ...
    "New Yew struct component": {
        ...
        blockquote![p![
            ...
            link!(
                ...
                text("请查看详细信息，并将相关的 bug 报告/问题/疑问直接发送到扩展的存储库",),
            ),
        ]],
        p![
            text("Rust-Yew 扩展 "),
