...
<html>
    ...
    <body></body>
        ...
        h2(vec![text("查看您的 Web 应用")]),
        p(vec![text("运行以下命令在本地构建和提供应用程序。")]),
...
port = 8000"#,
        ...
        p(vec![
            text("尝试这个应用程序，并查看"),
            link("/zh-Hans/docs/getting-started/examples", vec![text("示例")]),
            text("以进一步学习。"),
        ]),
    ])
}
