crate::doc_page!(
    ...
    Content::new(vec![
        ...
        p(vec![
            text("Passing "),
            link("/docs/0.20/concepts/function-components/properties", vec![text("props")]),
...
fn App() -> Html {
    ...
    html! {
        ...
        ul(vec![
            li(vec![
                link("/docs/0.20/advanced-topics/struct-components/hoc", vec![text("Higher Order Components")]),
