...
log_many("Logging", "many values!");"#),
        ...
        p(vec![
            ...
            text(" is a "),
            code("JsValue"),
            text(" and this is because JavaScript doesn't have a strong type system so any function that accepts a variable "),
            code("x"),
            text(" doesn't define its type so "),
            code("x"),
            text(" can be a valid JavaScript value; hence "),
            code("JsValue"),
            text(". If you are working with imported functions or types that accept a "),
            code("JsValue"),
            text(", then any imported value is technically valid."),
        ]),
        p(vec![
            code("JsValue"),
        ...
        p(vec![
            ...
            code("JsCast"),
            text(" to jump from one type to the other. It's a nice trait to get to know when working with "),
            code("web-sys"),
            text(", "),
            code("wasm_bindgen"),
            text(", "),
        ...
        p(vec![
            ...
            link("/docs/0.20/concepts/basic-web-technologies/web-sys", vec![code("web-sys")]),
        ...
        code_block("rust", r#"// need to import the trait.
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p(vec![
            ...
            link("/docs/0.20/concepts/html/events#using-closure-verbose", vec![text("Using Closure section")]),
            text(" on the "),
            link("/docs/0.20/concepts/html/events", vec![text("Events")]),
            text(" page."),
        ]),
        p(vec![
            link("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/closure/struct.Closure.html", vec![
        ...
        code_block("rust", r#"use web_sys::console;
