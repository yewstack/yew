crate::doc_page!(
    ...
    Content::new(vec![
        ...
        p(vec![
            text("In the "),
            link("/docs/0.20/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", vec![
        ...
        p(vec![
            ...
            link("/docs/0.20/concepts/basic-web-technologies/wasm-bindgen#jsvalue", vec![
                code("JsValue"),
            ]),
            text(":"),
        ]),
...
fn inheritance_of_text_area(text_area: HtmlTextAreaElement) {
    ...
    let event_target: &EventTarget = text_area.as_ref();
        ...
        p(vec![
            text("Yew uses a "),
            link("/docs/0.20/concepts/function-components/node-refs", vec![code("NodeRef")]),
            text(" in order to provide a way for keeping a reference to a "),
            code("Node"),
            text(" made by the "),
            link("/docs/0.20/concepts/html", vec![code("html!")]),
            text(" macro. The "),
            code("Node"),
            text(" part of "),
            code("NodeRef"),
            ...
            link("/docs/0.20/concepts/basic-web-technologies/wasm-bindgen#JsCast", vec![
                code("JsCast"),
            ]),
            text(" on the "),
            code("Node"),
...
// this event fires the closure is still in memory."#),
        ...
        p(vec![
            ...
            link("/docs/0.20/concepts/function-components/callbacks", vec![code("Callback")]),
