crate::doc_page!(
    ...
    Content::new(vec![
        ...
        p(vec![
            ...
            link("/docs/0.20/concepts/function-components/callbacks", vec![
                code("Callback"),
            ]),
...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        p(vec![
            ...
            link("/docs/0.20/advanced-topics/portals", vec![text("portals")]),
        ...
        p(vec![
            text("before starting your app. This speeds up event handling, but some components may break from not receiving events they expect. \
              Use this with care!"),
        ]),
        h2(vec![text("Event delegation")]),
        p(vec![
            text("It can be surprising that event listeners are not directly registered on the element where they are rendered. Instead, events \
        ...
        ul(vec![
            li(vec![
                ...
                link("/docs/0.20/concepts/function-components/node-refs", vec![
                    code("NodeRef"),
                ]),
