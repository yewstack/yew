    ...
    Content::new(vec![
        ...
        ol(vec![
            ...
            li(vec![
                ...
                link("/docs/0.20/concepts/suspense", vec![text("Suspense")]),
            ]),
        ]),
        p(vec![text(
        ...
        ul(vec![
            ...
            li(vec![code("use_effect_with_deps")]),
        ...
        p(vec![
            ...
            link(
                "/docs/0.20/concepts/function-components/hooks/custom-hooks#defining-custom-hooks",
