        ...
        admonition![
            ...
            p![
                ...
                link![
                    ...
                    text("the <Helmet/> component from Bounce"),
                ],
                text("."),
            ],
        ],
        ...
        admonition![
            ...
            p![
                ...
                link![
                    ...
                    text("if you have a <table> without a <tbody>, the browser may add a <tbody> to the DOM"),
                ],
                text("."),
            ],
        ],
