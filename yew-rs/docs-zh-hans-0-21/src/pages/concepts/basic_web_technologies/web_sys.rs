crate::doc_page!(
    ...
    Content::new(vec![
        ...
        p!["In the ", link!("/docs/0.21/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", "Simulating inheritance section"), code("web-sys"), " as understanding what methods are available on a type means understanding its inheritance."],
        p!["This section is going to look at a specific element and list out its inheritance using Rust by calling ", link!("https://doc.rust-lang.org/std/ops/trait.Deref.html#tymethod.deref", code("Deref::deref")), " until the value is ", link!("/docs/0.21/concepts/basic-web-technologies/wasm-bindgen#jsvalue", code("JsValue")), ":"],
        ...
        p!["Yew uses a ", link!("/docs/0.21/concepts/function-components/node-refs", code("NodeRef")), " to provide a way for keeping a reference to a ", code("Node"), " made by the ", link!("/docs/0.21/concepts/html", code("html!")), " macro. The ", code("Node"), " part of ", code("NodeRef"), " is referring to ", link!("https://wasm-bindgen.github.io/wasm-bindgen/api/web_sys/struct.Node.html", code("web_sys::Node")), ". The ", code("NodeRef::get"), " method will return a ", code("Option<Node>"), link!("/docs/0.21/concepts/basic-web-technologies/wasm-bindgen#jscast", code("JsCast")), " on the ", code("Node"), " value, if present, but Yew provides the ", code("NodeRef::cast"), code("wasm-bindgen"), " dependency for the ", code("JsCast"), " trait."],
        ...
        h3!["Yew example"],
        p!["In Yew you will mostly be creating ", link!("/docs/0.21/concepts/function-components/callbacks", code("Callback")), "s to use in the ", link!("/docs/0.21/concepts/html", code("html!"))],
