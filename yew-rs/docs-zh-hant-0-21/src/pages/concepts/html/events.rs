...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        h2_id("event-bubbling", vec![text("事件捕獲")]),
        p(vec![
        ...
        admonition(
            ...
            vec![
                p(vec![
                    text("在本節中，"),
                    bold(vec![text("target ([`Event.target`](https://developer.mozilla.org/en-US/docs/Web/API/Event/target))")]),
                    text(" 總是指的是事件從其派發的元素。"),
                ]),
                p(vec![
                    text("這"),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3(vec![text("使用 `NodeRef`")]),
        p(vec![
            link("", vec![text("NodeRef")]),
            text(" 可以取代查詢給定給 "),
            code("Callback"),
            text(" 的事件。"),
        ]),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h2_id("available-events", vec![text("可用事件的完整清單")]),
        p(vec![
            text("| 偵聽器名稱                  | "),
            code("web_sys"),
            text(" 事件類型                                                                    | | --------------------------- | ------------------------------------------------------------------------------------- | | "),
            code("onabort"),
            text("                   | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.Event.html", vec![text("Event")]),
            text("                     | | "),
            code("onauxclick"),
            text("                | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.MouseEvent.html", vec![text("MouseEvent")]),
            text("           | | "),
            code("onblur"),
            text("                    | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.FocusEvent.html", vec![text("FocusEvent")]),
            text("           | | "),
            code("oncancel"),
            text("                  | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.Event.html", vec![text("Event")]),
            ...
            code("ondrag"),
            text("                    | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.DragEvent.html", vec![text("DragEvent")]),
            text("             | | "),
            code("ondragend"),
            text("                 | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.DragEvent.html", vec![text("DragEvent")]),
            ...
            code("oninput"),
            text("                   | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.InputEvent.html", vec![text("InputEvent")]),
            text("           | | "),
            code("oninvalid"),
            text("                 | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.Event.html", vec![text("Event")]),
            ...
            code("onkeydown"),
            text("                 | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.KeyboardEvent.html", vec![text("KeyboardEvent")]),
            text("     | | "),
            code("onkeypress"),
            text("                | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.KeyboardEvent.html", vec![text("KeyboardEvent")]),
            ...
            code("onloadstart"),
            text("               | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.ProgressEvent.html", vec![text("ProgressEvent")]),
            text("     | | "),
            code("onmousedown"),
            text("               | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.MouseEvent.html", vec![text("MouseEvent")]),
            ...
            code("onsubmit"),
            text("                  | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.SubmitEvent.html", vec![text("SubmitEvent")]),
            text("         | | "),
            code("onsuspend"),
            text("                 | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.Event.html", vec![text("Event")]),
            ...
            code("onwheel"),
            text("                   | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.WheelEvent.html", vec![text("WheelEvent")]),
            text("           | | "),
            code("oncopy"),
            text("                    | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.Event.html", vec![text("Event")]),
            ...
            text("         | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.AnimationEvent.html", vec![text("AnimationEvent")]),
            text("   | | "),
            code("onanimationend"),
            text("            | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.AnimationEvent.html", vec![text("AnimationEvent")]),
            ...
            text("       | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.PointerEvent.html", vec![text("PointerEvent")]),
            text("       | | "),
            code("onloadend"),
            text("                 | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.ProgressEvent.html", vec![text("ProgressEvent")]),
            ...
            code("ontouchcancel"),
            text("             | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.TouchEvent.html", vec![text("TouchEvent")]),
            text("           | | "),
            code("ontouchend"),
            text("                | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.TouchEvent.html", vec![text("TouchEvent")]),
            ...
            text("        | "),
            link("https://docs.rs/web-sys/latest/web_sys/struct.TransitionEvent.html", vec![text("TransitionEvent")]),
            text(" | | "),
