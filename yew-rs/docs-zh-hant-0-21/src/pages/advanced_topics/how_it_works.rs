    ...
    Content::new(vec![
        ...
        p![
            ...
            " macro 會將使用類似 HTML 的自訂語法所編寫的程式碼轉換為有效的 Rust \
             ...
             API，如果你願意的話，可以直接使用。請注意，有些方法是有意未記錄的，以避免意外的誤用。\
             隨著 ",
            code("yew-macro"),
        ...
        p![
            ...
            " 巨集允許您以聲明式的風格編寫程式碼，因此您的 UI 佈局程式碼將與為頁面產生的 HTML \
             ...
             這種方式變得越來越有用。與手動編寫所有操作 DOM 的程式碼相比，巨集會為您處理好這一切。",
        ],
        p![
            "使用 ",
            code("html!"),
            " 巨集可能會讓人感到非常神奇，但它並沒有什麼可隱藏的。如果您對它的工作原理感到好奇，\
             可以嘗試展開您程式中的 ",
            code("html!"),
            " 巨集呼叫。有一個有用的指令叫做 ",
            code("cargo expand"),
        ...
        ol![
            ...
            li![
                "由於可能有 trait 方法名稱衝突，使用 ",
                code("<Type as Trait>"),
                " 來確保我們使用的是正確的 trait 成員。",
            ],
        ],
        h2!["什麼是虛擬 DOM？"],
        p![
