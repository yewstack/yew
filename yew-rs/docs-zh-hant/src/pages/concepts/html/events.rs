    ...
    //      ^^^^^^^ event listener name
        ...
        ul![
            li![
                ...
                code("HtmlElement"),
                text("，請使用 "),
                link!("/zh-Hant/docs/concepts/function-components/node-refs", text("NodeRef")),
                text("。"),
            ],
            li![
                link!(
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3![text("使用 "), code("Closure"), text("（冗長版本）")],
        p![
            text("直接使用 "),
            code("web-sys"),
            text(" 和 "),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3![text("使用 "), code("gloo"), text("（簡潔版本）")],
        p![
            text("更方便的方法是使用 "),
            code("gloo"),
            text("，更具體地說是 "),
