    ...
    Content::new(vec![
        ...
        ol(vec![
            li(vec![
                ...
                link("/zh-Hant/docs/concepts/html/fragments", vec![text("fragments")]),
                text(" 或"),
                link("/zh-Hant/docs/concepts/html/lists", vec![text("iterators")]),
                text(" 來規避這一點）"),
            ]),
            li(vec![
                text("空的 "),
...
html! { <my-element ~property="abc" /> };"#,
        ...
        admonition(
            ...
            vec![p(vec![
                ...
                link(
                    ...
                    vec![text("負數"), bold(vec![text("不是")]), text("字面量")],
                ),
                text("，因此必須用大括號括起來 "),
                code("{-6}"),
                text("。"),
        ...
        admonition(
            ...
            vec![p(vec![
                ...
                link("/zh-Hant/docs/concepts/function-components/properties", vec![text("元件屬性")]),
                text("中了解更多。"),
            ])],
        ),
        h3(vec![text("特殊屬性")]),
        ...
        p(vec![
            ...
            link("/zh-Hant/docs/concepts/function-components/node-refs", vec![text("Refs")]),
            text("。"),
        ]),
        p(vec![
            text("另一方面，"),
  ...
  if true {
      <p>{ "True case" }</p>
        ...
        admonition(
            ...
            vec![p(vec![
                text("閱讀"),
                link("/zh-Hant/docs/concepts/html/conditional-rendering", vec![text("條件渲染")]),
                text("一節以了解更多"),
            ])],
        ),
    ])
