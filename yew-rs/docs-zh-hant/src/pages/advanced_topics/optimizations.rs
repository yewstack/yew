pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        h2!["使用智慧指針"],
        p![bold![
            "注意：如果您對本節中使用的某些術語感到困惑，Rust 手冊中有一個有用的",
            link![
        ...
        p![
            ...
            code("Rc::ptr_eq"),
            " 的",
            link!["https://doc.rust-lang.org/stable/std/rc/struct.Rc.html#method.ptr_eq", "更多細節"],
            "。",
        ],
        p![
            "這種最佳化對於不實作 ",
...
lto = true"#),
        ...
        p![
            ...
            link!["https://doc.rust-lang.org/cargo/reference/unstable.html", "不穩定功能"],
            "的文檔，特別是關於",
...
build-std-features = ["panic_immediate_abort"]"#),
        admonition![
            ...
            p![
                ...
                link!["https://github.com/yewstack/yew/issues/2696", "這個例子"],
        ...
        p![
            ...
            link!["https://rustwasm.github.io/book/game-of-life/code-size.html", "縮小 .wasm 大小"],
        ],
        ul![
            li![
                "使用 ",
        ...
        ul![
            li![
                link!["https://doc.rust-lang.org/book/ch15-00-smart-pointers.html", "Rust 手冊中關於智慧型指標的章節"],
            ],
            li![
                link!["https://rustwasm.github.io/book/reference/code-size.html#optimizing-builds-for-code-size", "Rust Wasm 手冊中關於減小二進位檔案大小的資訊"],
            ],
            li![
                link!["https://doc.rust-lang.org/cargo/reference/profiles.html", "Rust 設定檔的文件"],
            ],
            li![
                link!["https://github.com/WebAssembly/binaryen", "binaryen 專案"],
            ],
        ],
    ])
}
