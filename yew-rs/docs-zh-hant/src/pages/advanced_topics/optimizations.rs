pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p![
            ...
            code("Rc::ptr_eq"),
            text(" 的"),
            link!["https://doc.rust-lang.org/stable/std/rc/struct.Rc.html#method.ptr_eq", text("更多細節")],
            text("。"),
        ],
        p![
            text("這種最佳化對於不實作 "),
...
lto = true"#),
        ...
        p![
            ...
            link!["https://doc.rust-lang.org/cargo/reference/unstable.html", text("不穩定功能")],
            text("的文檔，特別是關於"),
...
build-std-features = ["panic_immediate_abort"]"#),
        admonition![
            ...
            p![
                ...
                link!["https://github.com/yewstack/yew/issues/2696", text("這個例子")],
        ...
        p![
            ...
            link!["https://rustwasm.github.io/book/game-of-life/code-size.html", text("縮小 .wasm 大小")],
        ],
        ul![
            li![
                text("使用 "),
        ...
        h4![text("在 yew/examples/ 中 'minimal' 範例的建置大小")],
        p![
            text("注意："),
            code("wasm-pack"),
        ...
        ul![
            li![
                link!["https://doc.rust-lang.org/book/ch15-00-smart-pointers.html", text("Rust 手冊中關於智慧型指標的章節")],
            ],
            li![
                link!["https://rustwasm.github.io/book/reference/code-size.html#optimizing-builds-for-code-size", text("Rust Wasm 手冊中關於減小二進位檔案大小的資訊")],
            ],
            li![
                link!["https://doc.rust-lang.org/cargo/reference/profiles.html", text("Rust 設定檔的文件")],
            ],
            li![
                link!["https://github.com/WebAssembly/binaryen", text("binaryen 專案")],
            ],
        ],
    ])
}
