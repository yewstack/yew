...
async fn no_main() {
    ...
    println!("{}", rendered);
        ...
        h2(vec![text("渲染 "), code("<head>"), text(" 標籤")]),
        p(vec![
        ...
        p(vec![
            ...
            code("<head>"),
            text("。因此，head 標籤必須"),
            bold(vec![text("在伺服器端、Yew 之外")]),
            text("產生，並在傳送給客戶端之前拼接到 HTML 範本中。"),
        ]),
        p(vec![
            link("https://github.com/yewstack/yew/blob/master/examples/ssr_router/src/bin/ssr_router_server.rs", vec![code("ssr_router"), text(" 範例")]),
        ...
        admonition(
            ...
            vec![
                p(vec![
                    ...
                    link("https://docs.rs/bounce/latest/bounce/helmet/index.html", vec![text("Bounce 的 "), code("<Helmet/>"), text(" 元件")]),
                    text("。"),
                ]),
            ],
        ),
        ...
        admonition(
            ...
            vec![
                p(vec![
                    ...
                    link("https://github.com/yewstack/yew/issues/2684", vec![text("如果您有一個沒有"), code("<tbody>"), text(" 的"), code("<table>"), text("，瀏覽器可能會向DOM 添加一個"), code("<tbody>")]),
                ]),
            ],
        ),
        ...
        admonition(
            ...
            vec![
                p(vec![
                    ...
                    link("https://github.com/yewstack/yew/issues/new?assignees=&labels=bug&template=bug_report.md&title=", vec![text("請在 GitHub 回饋")]),
                    text("。"),
                ]),
            ],
        ),
