    ...
    Content::new(vec![
        ...
        admonition![AdmonitionType::Warning, Some("Important"),
            p![
                ...
                code("1.76.0"),
                ". Older versions will not compile. You can check your toolchain version using ",
                code("rustup show"),
                " (under \"active toolchain\") or ",
                code("rustc --version"),
...
cargo install --locked trunk"),
        ...
        ul![
            ...
            li![link!("https://github.com/rustminded/xtask-wasm/", code("xtask-wasm")), " (still in early development)"],
        ],
        h2!["Next steps"],
        p![
