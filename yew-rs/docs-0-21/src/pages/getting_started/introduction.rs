...
cargo install --locked trunk"),
        ...
        ul(vec![
            li(vec![link("https://github.com/drager/wasm-pack/", vec![code("wasm-pack")])]),
            li(vec![link("https://github.com/IMI-eRnD-Be/wasm-run", vec![code("wasm-run")])]),
            li(vec![link("https://github.com/rustminded/xtask-wasm/", vec![code("xtask-wasm")]), text(" (still in early development)")]),
        ]),
