crate::doc_page!("Getting Started", "/docs/getting-started",
    Content::new(vec![
        ...
        admonition![AdmonitionType::Warning, Some("Important"),
            p![
...
cargo install --locked trunk"),
        ...
        ul![
            li![link!("https://github.com/drager/wasm-pack/", code("wasm-pack"))],
            li![link!("https://github.com/IMI-eRnD-Be/wasm-run", code("wasm-run"))],
            li![link!("https://github.com/rustminded/xtask-wasm/", code("xtask-wasm")), text(" (still in early development)")],
        ],
        h2![text("Next steps")],
        p![
            text("With your development environment set up, you can now proceed with reading the documentation. \
