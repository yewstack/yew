...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p(vec![
            ...
            text(" and you can probably see, they allowed \
                  us to go from "),
            code("EventTarget"),
            text(" to "),
            link(
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3_id("using-closure-verbose", vec![text("Using "), code("Closure"), text(" (verbose)")]),
        p(vec![
            text("Using the "),
            code("web-sys"),
            text(" and "),
    ...
    html! {
        ...
        p(vec![
            ...
            link(
                ...
                vec![text("The "), code("wasm-bindgen"), text(" Guide")]
            ),
            text("."),
        ]),
