    ...
    Content::new(vec![
        p(vec![
            ...
            link(
                ...
                vec![text("The Rust and WebAssembly Working Group")]
            ),
            text("."),
        ]),
        p(vec![
...
log_many("Logging", "many values!");"#),
        p(vec![
            italic(vec![
                ...
                link(
                    ...
                    vec![text("1.2 Using console.log of The "), code("wasm-bindgen"), text(" Guide")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![text("extends section in The "), code("wasm-bindgen"), text(" Guide")]
                ),
            ]),
        ]),
        h3(vec![link(
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/struct.JsValue.html",
                    vec![code("JsValue"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
        h3_id("JsCast", vec![link(
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/trait.JsCast.html",
                    vec![code("JsCast"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/closure/struct.Closure.html",
                    vec![code("Closure"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![code("js-sys"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![code("wasm-bindgen-futures"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
    ...
    console::log_1(&string.into());
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/fn.spawn_local.html",
                    vec![code("spawn_local"), text(" documentation")]
                ),
                text("."),
            ]),
        ]),
