crate::doc_page!(
    ...
    Content::new(vec![
        ...
        p(vec![
            text("In the "),
            link(
                "/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance",
                vec![text("Simulating inheritance section")]
            ),
        ...
        p(vec![
            ...
            link(
                "/docs/concepts/basic-web-technologies/wasm-bindgen#jsvalue",
                vec![code("JsValue")]
            ),
            text(":"),
        ]),
...
fn inheritance_of_text_area(text_area: HtmlTextAreaElement) {
    ...
    let event_target: &EventTarget = text_area.as_ref();
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![text("Inheritance in "), code("web-sys"), text(" in The "), code("wasm-bindgen"), text(" Guide")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            ...
            link(
                "/docs/concepts/basic-web-technologies/wasm-bindgen#JsCast",
                vec![code("JsCast")]
            ),
            text(" on the "),
            code("Node"),
