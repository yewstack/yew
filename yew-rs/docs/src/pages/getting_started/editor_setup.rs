...
impl Component for $NAME$ {
    ...
    "rust": "html",
        ...
        h4!["Lazyvim"],
        blockquote![p![
            "The below configuration works with ",
            link!("https://www.lazyvim.org", "LazyVim"),
            " and the lazy.vim plugin. Create a file in ",
