...
async fn no_main() {
    ...
    println!("{}", rendered);
        ...
        admonition![AdmonitionType::Caution, Some("Web APIs are not available!"),
            p![
        ...
        h2![text("Rendering "), code("<head>"), text(" Tags")],
        p![
        ...
        admonition![AdmonitionType::Info, None,
            p![
                ...
                link!["https://docs.rs/bounce/latest/bounce/helmet/index.html", text("the "), code("<Helmet/>"), text(" component from Bounce")],
                text("."),
            ],
        ],
