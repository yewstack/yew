pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p(vec![
            ...
            link("https://doc.rust-lang.org/stable/std/rc/struct.Rc.html#method.ptr_eq", vec![text("more details about "), code("Rc::ptr_eq")]),
            text("."),
        ]),
        p(vec![
...
lto = true"#),
        ...
        p(vec![
            ...
            link("https://doc.rust-lang.org/cargo/reference/unstable.html#build-std", vec![code("build-std")]),
            text(" and "),
            link("https://doc.rust-lang.org/cargo/reference/unstable.html#build-std-features", vec![code("build-std-features")]),
