...
html! { <my-element ~property="abc" /> };"#),
        ...
        admonition!(AdmonitionType::Note, Some("What classifies as a literal"),
            p![
                ...
                link!("https://users.rust-lang.org/t/why-are-negative-value-literals-expressions/43333", text("negative numbers are "), bold![text("not")], text(" literals")),
        ...
        h2![text("Comments")],
        p![text("It is also possible to use Rust style comments as part of the HTML structure:")],
        code_block("rust", r#"use yew::prelude::*;
  ...
  <>
    ...
    <main>
      { "…" }
        ...
        p![text("Comments will be dropped during the parsing process and will not end up in the final output.")],
