pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p(vec![
            ...
            link("/docs/concepts/function-components/callbacks", vec![
                code("Callback"),
            ]),
        ...
        admonition(AdmonitionType::Tip, None, vec![
            p(vec![
                ...
                code("web-sys"),
                text(" as a dependency in your crate because you will not \
...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        p(vec![
            ...
            link("#available-events", vec![text("full list of available event")]),
        ...
        p(vec![
            ...
            text(" starting your app. This speeds up event handling, but some components may break from not receiving the events they expect. \
              Use this with care!"),
        ]),
        ...
        p(vec![
            text("In all the approaches below we are going to tackle the same problem, so it is clear where the approach \
              differs as opposed to the problem at hand."),
        ]),
        p(vec![
            bold(vec![text("The Problem:")]),
        ]),
        p(vec![
            text("We have an "),
            code("onchange"),
            ...
            text(" on my "),
            code("<input>"),
            text(" element and each time it is invoked we want to send an "),
            link("/docs/concepts/html/components#update", vec![text("update")]),
            text(" "),
            code("Msg"),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p(vec![
            ...
            text(" and you can probably see, they allowed us to go from "),
            code("EventTarget"),
            text(" to "),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p(vec![
            text("Which approach you take depends on your component and your preferences, there is no "),
            italic(vec![text("blessed")]),
            text(" way per se."),
        ]),
        ...
        p(vec![
            ...
            text(" API's directly for this can be a bit painful.. so brace \
              yourself ("),
            link("#using-gloo-concise", vec![text("there is a more concise way thanks to "), code("gloo")]),
            text(")."),
        ]),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        table(
            vec![vec![text("Event listener name")], vec![code("web_sys"), text(" Event Type")]],
            vec![
...
crate::doc_page!("Events", "/docs/concepts/html/events", page_content());
