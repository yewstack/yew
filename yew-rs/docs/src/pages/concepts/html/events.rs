...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        p![
            ...
            link!("#available-events", "full list of available event"),
            " with their types.",
        ],
        ...
        p![
            italic!["before"],
            " starting your app. This speeds up event handling, but some components may break from not receiving the events they expect. \
              Use this with care!",
        ],
        h2!["Event delegation"],
        p![
        ...
        ul![
            ...
            li![
                ...
                link!("#event-bubbling", "bubbles ", italic!["up"]),
                ", i.e. event listeners higher up in \
                  the virtual DOM will trigger ",
                italic!["after"],
                " event listeners below them. Currently, capturing listeners is not supported by Yew. \
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p![
            ...
            " and you can probably see, they allowed us to go from ",
            code("EventTarget"),
            " to ",
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p![
            ...
            code("JsCast"),
            ", or know the trait, you can probably see that ",
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p![
            ...
            code("String"),
            " back into state as we always access to ",
            code("input_node_ref"),
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p![
            "Which approach you take depends on your component and your preferences, there is no ",
            italic!["blessed"],
            " way per se.",
        ],
        ...
        p![
            ...
            " API's directly for this can be a bit painful.. so brace \
              yourself (",
            link!("#using-gloo-concise", "there is a more concise way thanks to ", code("gloo")),
            ").",
        ],
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3_id!("using-gloo-concise", "Using ", code("gloo"), " (concise)"),
        p![
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        table(
            vec![vec!["Event listener name".into()], vec![code("web_sys"), " Event Type".into()]],
            vec![
