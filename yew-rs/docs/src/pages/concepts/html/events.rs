...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        p![
            ...
            link!("#available-events", text("full list of available event")),
        ...
        p![
            ...
            link!("/docs/advanced-topics/portals", text("portals")),
        ...
        ul![
            ...
            li![
                ...
                link!("#event-bubbling", text("bubbles "), italic![text("up")]),
        ...
        p![
            ...
            link!("/docs/concepts/html/components#update", text("update")),
            text(" "),
            code("Msg"),
    ...
    html! {
        ...
        p![
            ...
            text(" API's directly for this can be a bit painful.. so brace \
              yourself ("),
            link!("#using-gloo-concise", text("there is a more concise way thanks to "), code("gloo")),
            text(")."),
        ],
