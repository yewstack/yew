pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        h2(vec![text("Features in "), code("web-sys")]),
        p(vec![
            text("The "),
            code("web-sys"),
        ...
        h2(vec![text("Inheritance in "), code("web-sys")]),
        p(vec![
            text("In the "),
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", vec![
        ...
        p(vec![
            ...
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#jsvalue", vec![
                code("JsValue"),
            ]),
            text(":"),
        ]),
...
fn inheritance_of_text_area(text_area: HtmlTextAreaElement) {
    ...
    let event_target: &EventTarget = text_area.as_ref();
        ...
        h2(vec![text("The "), code("Node"), text(" in "), code("NodeRef")]),
        p(vec![
            text("Yew uses a "),
            ...
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#JsCast", vec![
                code("JsCast"),
            ]),
            text(" on the "),
            code("Node"),
...
features = [
    ...
    \"DomRect\",
        ...
        code_block_no_run("rust", "use wasm_bindgen::{prelude::Closure, JsCast};
