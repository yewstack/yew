pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p![
            ...
            link!("https://wasm-bindgen.github.io/wasm-bindgen/", text("The "), code("wasm-bindgen"), text(" Guide")),
            text("."),
        ],
        p![
        ...
        h3![code("#[wasm_bindgen]"), text(" macro")],
        p![
            text("The "),
            code("#[wasm_bindgen]"),
...
log_many("Logging", "many values!");"#),
        p![
            italic![
                ...
                link!("https://wasm-bindgen.github.io/wasm-bindgen/examples/console-log.html",
                    text("1.2 Using console.log of The "), code("wasm-bindgen"), text(" Guide"),
                ),
                text("."),
            ],
        ],
        h3_id!("simulating-inheritance", text("Simulating inheritance")),
        p![
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/reference/attributes/on-js-imports/extends.html",
                    text("extends section in The "), code("wasm-bindgen"), text(" Guide"),
                ),
            ],
        ],
        h3_id!("jsvalue",
        ...
        p![
            ...
            code("wasm-bindgen"),
            text(" APIs, check the your JavaScript's documentation for types of inputs that will cause an exception (and a panic)."),
        ],
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/struct.JsValue.html",
                    code("JsValue"), text(" documentation"),
                ),
                text("."),
            ],
        ],
        ...
        p![
            code("JsCast"),
            text(" provides both checked and unchecked methods of casting - so if at runtime if you are \
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/trait.JsCast.html",
                    code("JsCast"), text(" documentation"),
                ),
                text("."),
            ],
        ],
        ...
        p![
            ...
            link!("/docs/concepts/html/events#using-closure-verbose", text("Using "), code("Closure"), text(" section")),
            text(" on the "),
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/closure/struct.Closure.html",
                    code("Closure"), text(" documentation"),
                ),
                text("."),
            ],
        ],
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/js_sys/index.html",
                    code("js-sys"), text(" documentation"),
                ),
                text("."),
            ],
        ],
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/index.html",
                    code("wasm-bindgen-futures"), text(" documentation"),
                ),
                text("."),
            ],
        ],
...
spawn_local(async {
    ...
    console::log_1(&string.into());
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/fn.spawn_local.html",
                    code("spawn_local"), text(" documentation"),
                ),
                text("."),
            ],
        ],
