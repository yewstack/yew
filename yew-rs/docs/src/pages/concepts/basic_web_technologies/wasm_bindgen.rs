pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p![
            ...
            link!("https://wasm-bindgen.github.io/wasm-bindgen/", "The ", code("wasm-bindgen"), " Guide"),
            ".",
        ],
        p![
        ...
        h2![
            link!("https://crates.io/crates/wasm-bindgen", code("wasm-bindgen")),
        ],
        p![
        ...
        code_block_no_run("rust", r#"use wasm_bindgen::prelude::*;
...
log_many("Logging", "many values!");"#),
        p![
            italic![
                ...
                link!("https://wasm-bindgen.github.io/wasm-bindgen/examples/console-log.html",
                    "1.2 Using console.log of The ", code("wasm-bindgen"), " Guide",
                ),
                ".",
            ],
        ],
        h3_id!("simulating-inheritance", "Simulating inheritance"),
        p![
        ...
        p![
            "It is important to note that every single type imported using ",
            code("#[wasm-bindgen]"),
        ...
        p![
            ...
            code("wasm-bindgen"),
            ". Because JavaScript does not have a strong type system, any type that comes from ",
            code("wasm-bindgen"),
            " is a ",
            code("JsValue"),
            ". Functions in JavaScript do not define the type of any variables they take in or return; \
        ...
        p![
            "Even though ",
            code("JsValue"),
            " may be accepted by a JS function, that function may still only ",
            italic!["actually"],
            " accept certain types. Passing an incorrect ",
            code("JsValue"),
            " can lead to an exception which triggers a panic - so when using raw ",
            code("wasm-bindgen"),
            " APIs, check the your JavaScript's documentation for types of inputs that will cause an exception (and a panic).",
        ],
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/struct.JsValue.html",
                    code("JsValue"), " documentation",
                ),
                ".",
            ],
        ],
        ...
        p![
            ...
            code("JsCast"),
            " to jump from one type to the other. It is a nice trait to get to know when working with ",
            code("web-sys"),
            ", ",
            code("wasm_bindgen"),
            ", ",
            code("js-sys"),
            " - you will notice lots of types will implement ",
            code("JsCast"),
            " from those crates.",
        ],
        p![
            code("JsCast"),
            " provides both checked and unchecked methods of casting - so if at runtime if you are \
        ...
        code_block("rust", "// need to import the trait.
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p![
            ...
            " method will consume ",
            code("self"),
            ", as per convention for ",
            code("into"),
            " methods in Rust, and the type returned is ",
            code("Result<T, Self>"),
        ...
        p![
            ...
            doc_link!(crate::pages::concepts::html::events, #"using-closure-verbose", "Using ", code("Closure"), " section"),
            " on the ",
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/closure/struct.Closure.html",
                    code("Closure"), " documentation",
                ),
                ".",
            ],
        ],
        h2![
            link!("https://crates.io/crates/js-sys", code("js-sys")),
        ],
        p![
            "The ",
            code("js-sys"),
        ...
        p![
            "This does not include any web APIs; that's what ",
            doc_link!(crate::pages::concepts::basic_web_technologies::web_sys, code("web-sys")),
            " is for!",
        ],
        p![
        ...
        ol![
            li_blocks![
                p![
                    ...
                    ". This Future will resolve to ",
                    code("Ok"),
                    " if the Promise is resolved and ",
                    code("Err"),
                    " if the Promise is rejected, containing the resolved or rejected value from the Promise respectively.",
                ],
            ],
            li_blocks![
                p![
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/index.html",
                    code("wasm-bindgen-futures"), " documentation",
                ),
                ".",
            ],
        ],
        ...
        code_block_no_run("rust", "use web_sys::console;
...
spawn_local(async {
    ...
    console::log_1(&string.into());
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/fn.spawn_local.html",
                    code("spawn_local"), " documentation",
                ),
                ".",
            ],
        ],
