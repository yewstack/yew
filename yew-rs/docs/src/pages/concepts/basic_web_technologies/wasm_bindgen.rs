pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        ...
        p(vec![
            ...
            link("https://wasm-bindgen.github.io/wasm-bindgen/", vec![text("The "), code("wasm-bindgen"), text(" Guide")]),
            text("."),
        ]),
        p(vec![
        ...
        h2(vec![
            link("https://crates.io/crates/wasm-bindgen", vec![code("wasm-bindgen")]),
        ]),
        p(vec![
...
log_many("Logging", "many values!");"#),
        ...
        h3_id("simulating-inheritance", vec![text("Simulating inheritance")]),
        p(vec![
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        h2(vec![
            link("https://crates.io/crates/js-sys", vec![code("js-sys")]),
        ]),
        p(vec![
            text("The "),
            code("js-sys"),
