    ...
    html! {
        ...
        ul![
            ...
            li![
                ...
                link!("https://github.com/yewstack/yew/tree/master/examples/contexts/src/struct_component_subscriber.rs", text("example of struct component as a consumer")),
            ],
        ],
        h2![text("Use cases")],
        ...
        p![
            text("The "),
            link!("https://github.com/yewstack/yew/tree/master/examples/contexts", text("contexts example")),
