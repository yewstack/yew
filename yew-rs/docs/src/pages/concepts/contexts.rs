pub fn page_content() -> yew_site_lib::Content {
    ...
    Content::new(vec![
        p(vec![
            ...
            italic(vec![text("any")]),
            text(" component in the tree below it, no matter how deep, without having to pass it down with props."),
        ]),
...
fn App() -> Html {
    ...
    html! {
        ...
        p(vec![
            ...
            text(" and "),
            code("NavButton"),
            text(", the components that need access to the theme, can just access the theme without having to pass it to them as a prop. Contexts solve this problem by allowing a parent to pass data, theme in this case, to its children."),
        ]),
        ...
        p(vec![
            ...
            text(" is the component whose children will have the context available to them. The children are re-rendered when the context changes. A struct is used to define what data is to be passed. The "),
            code("ContextProvider"),
            text(" can be used as:"),
        ]),
...
pub fn ThemedButton() -> Html {
    ...
    html! {
        ...
        p(vec![
            code("use_context"),
            text(" hook is used to consume contexts in function components. See "),
        ...
        ul(vec![
            ...
            li(vec![
                ...
                link("https://github.com/yewstack/yew/tree/master/examples/contexts/src/struct_component_subscriber.rs", vec![text("example of struct component as a consumer")]),
            ]),
        ]),
        ...
        p(vec![
            text("For example, you may be able to extract a component and pass that component as a child to another component. For example, you may have a "),
            code("Layout"),
        ...
        p(vec![
            text("The "),
            link("https://github.com/yewstack/yew/tree/master/examples/contexts", vec![text("contexts example")]),
...
crate::doc_page!("Contexts", "/docs/concepts/contexts", page_content());
