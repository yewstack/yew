crate::doc_page!(
    ...
    Content::new(vec![
        ...
        h2![text("リアクティブ性")],
        p![text(
            "再レンダリング時に、Yew は仮想DOMを調整する際にプロパティが変更されたかどうかを確認し、\
...
"#
        ...
        admonition!(
            ...
            None,
            p![text(
                "属性は Rustdoc によって生成されたドキュメントには表示されません。\
...
fn Case2() -> Html {
    html! {<HelloWorld name={"Sam".to_string()} />}
        ...
        p![text(
            "内部プロパティは参照カウントされたスマートポインタとして渡されます。\
...
fn main() {
    ...
    assert_eq!(props.last, 3);
        ...
        h2![text("アンチパターン")],
        p![text(
            "ほとんどのRust型はプロパティとして渡すことができますが、避けるべきアンチパターンが\
        ...
        ol![
            ...
            li_blocks!(p![text(
                "新しい発見があるかもしれません。早く知っておきたかったエッジケースに遭遇しましたか？\
