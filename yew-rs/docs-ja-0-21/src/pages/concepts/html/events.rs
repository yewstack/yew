...
html! {
    ...
    //      ^^^^^^^ event listener name
        ...
        p![
            ...
            link!["/ja/docs/advanced-topics/portals", text("portals")],
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        p![text("Which approach you take depends on your component and your preferences, there is no blessed way per se.")],
...
fn MyComponent() -> Html {
    ...
    html! {
        ...
        h3_id!["using-gloo-concise", text("Using gloo (concise)")],
        p![
