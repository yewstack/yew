...
log_many("Logging", "many values!");"#),
        p![
            italic![
                ...
                link![
                    ...
                    "1.2 Using console.log of The wasm-bindgen Guide"
                ],
                ".",
            ],
        ],
        ...
        p![
            ...
            code("wasm-bindgen"),
            " APIs, check your JavaScript's documentation for types of inputs that will cause an exception (and a panic).",
        ],
        p![
            italic![
                link![
        ...
        p![
            "Rust has a strong type system and JavaScript does not. For Rust to maintain these \
        ...
        p![
            code("JsCast"),
            " provides both checked and unchecked methods of casting - so if at runtime you are \
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p![
            ...
            link!["/ja/docs/concepts/html/events#using-closure-verbose", "Using Closure section"],
            " on the ",
