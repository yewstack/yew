...
log_many("Logging", "many values!");"#),
        p(vec![
            italic(vec![
                ...
                link(
                    ...
                    vec![text("1.2 Using console.log of The wasm-bindgen Guide")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![text("extends section in The wasm-bindgen Guide")]
                ),
            ]),
        ]),
        h3(vec![link(
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/struct.JsValue.html",
                    vec![text("JsValue documentation")]
                ),
                text("."),
            ]),
        ]),
...
fn handle_event(event: Event) {
    ...
    let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p(vec![
            ...
            link("/ja/docs/concepts/html/events#using-closure-verbose", vec![text("Using Closure section")]),
            text(" on the "),
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/closure/struct.Closure.html",
                    vec![text("Closure documentation")]
                ),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            italic(vec![
                link(
                    ...
                    vec![text("wasm-bindgen-futures documentation")]
                ),
                text("."),
            ]),
        ]),
    ...
    console::log_1(&string.into());
        ...
        p(vec![
            italic(vec![
                link(
                    "https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/fn.spawn_local.html",
                    vec![text("spawn_local documentation")]
                ),
                text("."),
            ]),
        ]),
