crate::doc_page!("Contexts", "/ja/docs/concepts/contexts",
    Content::new(vec![
        p![
            ...
            italic!["any"],
            " component in the tree below it, no matter how deep, \
...
pub fn ThemedButton() -> Html {
    ...
    html! {
        ...
        ul![
            li![
                link!("/ja/docs/advanced-topics/struct-components/hoc", "Higher Order Components"),
            ...
            li![
                ...
                link!(
                    ...
                    "example of struct component as a consumer"
                ),
            ],
        ],
        h2!["Use cases"],
