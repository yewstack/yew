crate::doc_page!("web-sys", "/zh-Hant/docs/concepts/basic-web-technologies/web-sys",
    Content::new(vec![
        p(vec![
            text("The "),
        ...
        p(vec![
            text("In the "),
            link("/zh-Hant/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", vec![text("Simulating inheritance section")]),
...
let event_target: &EventTarget = text_area.as_ref();
        ...
        p(vec![
            ...
            code("Node"),
            text(" made by the "),
            link("/zh-Hant/docs/concepts/html", vec![code("html!")]),
            text(" macro. The "),
            code("Node"),
            text(" part of "),
            code("NodeRef"),
