crate::doc_page!("wasm-bindgen", "/zh-Hant/docs/concepts/basic-web-technologies/wasm-bindgen",
    Content::new(vec![
        p![
...
let input_element: HtmlInputElement = target.unchecked_into();
        ...
        p![
            ...
            link!["/zh-Hant/docs/concepts/html/events#using-closure-verbose", text("Using Closure section")],
            text(" on the "),
            link!["/zh-Hant/docs/concepts/html/events", text("Events")],
            text(" page."),
        ],
        p![
            italic![
