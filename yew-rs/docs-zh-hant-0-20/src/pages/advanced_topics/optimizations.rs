...
lto = true"#,
        ...
        h2(vec![text("使用 Cargo Workspaces 加速編譯")]),
        p(vec![
        ...
        p(vec![link(
            ...
            vec![text("Rust profiles documentation")],
        )]),
        code_block(
            "rust",
            r#"[unstable]
