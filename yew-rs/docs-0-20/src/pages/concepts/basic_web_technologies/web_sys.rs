crate::doc_page!("web-sys", "/docs/concepts/basic-web-technologies/web-sys",
    Content::new(vec![
        p![
            text("The "),
            link!("https://crates.io/crates/web-sys", code("web-sys"), text(" crate")),
        ...
        p![
            text("In the "),
            link!("/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", text("Simulating inheritance section")),
...
let event_target: &EventTarget = text_area.as_ref();
        ...
        p![
            italic![
                link!("https://wasm-bindgen.github.io/wasm-bindgen/web-sys/inheritance.html", text("Inheritance in web-sys in The wasm-bindgen Guide")),
                text("."),
            ],
        ],
