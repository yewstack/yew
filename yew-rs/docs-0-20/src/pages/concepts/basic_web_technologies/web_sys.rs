crate::doc_page!("web-sys", "/docs/concepts/basic-web-technologies/web-sys",
    Content::new(vec![
        p(vec![
            text("The "),
            link("https://crates.io/crates/web-sys", vec![code("web-sys"), text(" crate")]),
        ...
        p(vec![
            text("In the "),
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", vec![text("Simulating inheritance section")]),
        ...
        p(vec![
            ...
            link("https://doc.rust-lang.org/std/ops/trait.Deref.html#tymethod.deref", vec![code("Deref::deref")]),
            text(" until the value is "),
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#jsvalue", vec![code("JsValue")]),
            text(":"),
        ]),
        code_block("rust",
"use std::ops::Deref;
...
let event_target: &EventTarget = text_area.as_ref();
        ...
        p(vec![
            italic(vec![
                link("https://wasm-bindgen.github.io/wasm-bindgen/web-sys/inheritance.html", vec![text("Inheritance in web-sys in The wasm-bindgen Guide")]),
                text("."),
            ]),
        ]),
        ...
        p(vec![
            ...
            code("Node"),
            text(" made by the "),
            link("/docs/concepts/html", vec![code("html!")]),
            text(" macro. The "),
            code("Node"),
            text(" part of "),
            code("NodeRef"),
            text(" is referring to "),
            link("https://wasm-bindgen.github.io/wasm-bindgen/api/web_sys/struct.Node.html", vec![code("web_sys::Node")]),
            text(". The "),
            code("NodeRef::get"),
            ...
            link("/docs/concepts/basic-web-technologies/wasm-bindgen#JsCast", vec![code("JsCast")]),
            text(" on the "),
            code("Node"),
        ...
        p(vec![
            ...
            link("https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen/trait.JsCast.html#method.dyn_into", vec![code("JsCast::dyn_into")]),
            text(" on the "),
            code("web_sys::Node"),
            text(" returned from "),
            code("NodeRef::get"),
...
console.log('Left? : ' + x + ' ; Top? : ' + y + '.')
        ...
        code_block_title("toml", "Cargo.toml",
"[dependencies]
wasm-bindgen = \"0.2\"
...
<div id=\"mousemoveme\" {onmousemove}></div>
        ...
        p(vec![
            italic(vec![
                link("/community/external-libs", vec![text("External libraries page")]),
            ]),
        ]),
    ])
);
