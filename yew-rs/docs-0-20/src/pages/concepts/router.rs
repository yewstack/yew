    ...
    NotFound,
        ...
        p![
            ...
            " attribute. If no route is specified, nothing is rendered, and a message is logged \
             to console stating that no route was matched.",
        ],
        p![
        ...
        admonition(
            ...
            vec![p![
                ...
                code("<BrowserRouter />"),
                " is highly recommended. You can find other router flavours in the ",
        ...
        admonition(
            ...
            vec![p![
                ...
                " is rendered with another router, the field can then be redundant as the other \
                 router is able to match and handle the path. See the ",
...
// switch function renders News and id as is. Omitted here."##
        ...
        p![
            ...
            ", and push the targeted page to the history and render the desired page, which is \
             what should be expected from a Single Page App. The default onclick of a normal \
             anchor element would reload the page.",
        ],
        p![
            "The ",
            code("<Link />"),
        ...
        p![
            "Navigator API is provided for both function components and struct components. They \
             enable callbacks to change the route. An ",
            code("Navigator"),
    ...
    html! {
        ...
        admonition(
            ...
            vec![p![
                ...
                code("Callback::from"),
                ". Use a normal callback if the target route can be the same with the route the \
                 component is in, or just to play safe. For example, when you have a logo button \
                 on every page, that goes back to home when clicked, clicking that button twice \
                 on home page causes the code to panic because the second click pushes an \
                 identical Home route and the ",
                code("use_navigator"),
                " hook won't trigger a re-render.",
            ]]
        ),
        p![
...
pub fn nav_items() -> Html {
    ...
    html! {
        ...
        p![
            ...
            " API. The rest is identical with the function component case. Here's an example of a \
...
fn some_page() -> Html {
    ...
    // ... actual page content.
        ...
        admonition(
            ...
            vec![p![
                ...
                code("<Redirect />"),
                " in other non-component context, for example in the switch function of a ",
                link!("#nested-router", "Nested Router"),
                ".",
            ]]
        ),
        ...
        admonition(
            AdmonitionType::Note,
            None,
            vec![p!["The location listener will get unregistered once it \
                     is dropped. Make sure to store the handle inside your \
                     component state."]]
        ),
        code_block(
            "rust",
    ...
    MyComponent {
        ...
        h4!["Obtaining query parameters for current route"],
        p![
            code("location.query"),
            " is used to obtain the query parameters. It uses ",
            code("serde"),
            " to deserialize the parameters from query string in the URL.",
        ],
        ...
        admonition(
            AdmonitionType::Warning,
            None,
            vec![p!["Though note that this is still work in progress so \
                     the way we do this is not final"]]
        ),
