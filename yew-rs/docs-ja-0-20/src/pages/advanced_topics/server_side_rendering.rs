...
fn main() {
    ...
    renderer.hydrate();
        ...
        ul(vec![
            li(vec![
                text("Example: "),
                link("https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/simple_ssr", vec![text("simple_ssr")]),
            ]),
            li(vec![
                text("Example: "),
                link("https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/ssr_router", vec![text("ssr_router")]),
            ]),
        ]),
        admonition(AdmonitionType::Caution, None, vec![
            p(vec![
