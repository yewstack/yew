...
fn main() {
    ...
    renderer.hydrate();
        ...
        ul![
            li![
                text("Example: "),
                link!["https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/simple_ssr", text("simple_ssr")],
            ],
            li![
                text("Example: "),
                link!["https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/ssr_router", text("ssr_router")],
            ],
        ],
        admonition![AdmonitionType::Caution, None,
            p![
