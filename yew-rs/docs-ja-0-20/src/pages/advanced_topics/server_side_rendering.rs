...
fn main() {
    ...
    renderer.hydrate();
        ...
        ul![
            li![
                "Example: ",
                link!["https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/simple_ssr", "simple_ssr"],
            ],
            li![
                "Example: ",
                link!["https://github.com/yewstack/yew/tree/yew-v0.20.0/examples/ssr_router", "ssr_router"],
            ],
        ],
        admonition![AdmonitionType::Caution, None,
            p![
