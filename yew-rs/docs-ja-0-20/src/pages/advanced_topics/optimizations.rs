crate::doc_page!("Optimizations & Best Practices", "/ja/docs/advanced-topics/optimizations",
    Content::new(vec![
        ...
        p(vec![
            bold(vec![
                ...
                link("https://doc.rust-lang.org/book/ch15-00-smart-pointers.html", vec![text("chapter about smart pointers")]),
                text("."),
            ]),
        ]),
        p(vec![
            text("In an effort to avoid cloning large amounts of data to create props when re-rendering, we can use \
        ...
        p(vec![
            ...
            link("https://doc.rust-lang.org/stable/std/rc/struct.Rc.html#method.ptr_eq", vec![text("more details about Rc::ptr_eq")]),
            text("."),
        ]),
        p(vec![
        ...
        p(vec![
            ...
            code("Rc<_>"),
            text("s a good choice for wrapping property values in for pure components."),
        ]),
        p(vec![
        ...
        p(vec![
            ...
            code("html!"),
            text(" macro. This tends to not be much of an issue for smaller projects, but for larger applications it makes \
        ...
        p(vec![
            ...
            code("Html"),
            text(". Code which is shared between the crates containing different parts of \
        ...
        ul(vec![
            li(vec![text("optimize Rust code")]),
            li(vec![
                code("cargo.toml"),
        ...
        code_block("toml", r#"[profile.release]
...
build-std-features = ["panic_immediate_abort"]"#),
        admonition(AdmonitionType::Caution, None, vec![
            p(vec![
                ...
                link("https://github.com/yewstack/yew/issues/2696", vec![text("this one")]),
                text(", that require occasional attention and tweaking. Use these experimental options with care."),
            ]),
        ]),
        h3(vec![text("wasm-opt")]),
        p(vec![
            text("Further more it is possible to optimize size of "),
            code("wasm"),
            text(" code."),
        ]),
        p(vec![
        ...
        ul(vec![
            li(vec![
                link("https://doc.rust-lang.org/book/ch15-00-smart-pointers.html", vec![text("The Rust Book's chapter on smart pointers")]),
            ]),
            li(vec![
                link("https://rustwasm.github.io/book/reference/code-size.html#optimizing-builds-for-code-size", vec![text("Information from the Rust Wasm Book about reducing binary sizes")]),
            ]),
            li(vec![
                link("https://doc.rust-lang.org/cargo/reference/profiles.html", vec![text("Documentation about Rust profiles")]),
            ]),
            li(vec![
                link("https://github.com/WebAssembly/binaryen", vec![text("binaryen project")]),
            ]),
        ]),
    ])
);
