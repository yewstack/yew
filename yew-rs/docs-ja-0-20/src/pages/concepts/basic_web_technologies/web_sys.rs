crate::doc_page!("web-sys", "/ja/docs/concepts/basic-web-technologies/web-sys",
    Content::new(vec![
        ...
        p![
            "In the ",
            link!["/ja/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", "Simulating inheritance section"],
        ...
        p![
            ...
            " until the value is ",
            link!["/ja/docs/concepts/basic-web-technologies/wasm-bindgen#jsvalue", code("JsValue")],
            ":",
        ],
        code_block("rust",
"use std::ops::Deref;
...
let event_target: &EventTarget = text_area.as_ref();
        ...
        p![
            ...
            link!["/ja/docs/concepts/basic-web-technologies/wasm-bindgen#JsCast", code("JsCast")],
            " on the ",
            code("Node"),
