crate::doc_page!("web-sys", "/ja/docs/concepts/basic-web-technologies/web-sys",
    Content::new(vec![
        p(vec![
            text("The "),
        ...
        p(vec![
            text("In the "),
            link("/ja/docs/concepts/basic-web-technologies/wasm-bindgen#simulating-inheritance", vec![text("Simulating inheritance section")]),
        ...
        p(vec![
            ...
            link("/ja/docs/concepts/basic-web-technologies/wasm-bindgen#jsvalue", vec![code("JsValue")]),
            text(":"),
        ]),
        code_block("rust",
"use std::ops::Deref;
...
let event_target: &EventTarget = text_area.as_ref();
        ...
        p(vec![
            ...
            code("Node"),
            text(" made by the "),
            link("/ja/docs/concepts/html", vec![code("html!")]),
            text(" macro. The "),
            code("Node"),
            text(" part of "),
            code("NodeRef"),
            ...
            link("/ja/docs/concepts/basic-web-technologies/wasm-bindgen#JsCast", vec![code("JsCast")]),
            text(" on the "),
            code("Node"),
