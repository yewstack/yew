crate::doc_page!(
    ...
    Content::new(vec![
        h2!["Iterators"],
        p!["Yew supports two different syntaxes for building HTML from an iterator."],
        p![
            "The first is to call ",
            code("collect::<Html>()"),
            " on the final transform in your iterator, which returns a list that Yew can display.",
        ],
        code_block(
            "rust",
            r#"use yew::prelude::*;
...
{ items.iter().collect::<Html>() }
        ...
        p![
            ...
            code("for"),
            " keyword, which is not native Rust syntax and instead is used by the HTML macro to \
             output the needed code to display the iterator.",
        ],
        code_block(
            "rust",
            r#"use yew::prelude::*;
...
{ for items.iter() }
        ...
        p![
            ...
            " children. ",
            code("key"),
            " is a special prop provided by Yew which gives an html element or component a unique \
             identifier which is used for optimization purposes inside Yew.",
        ],
        admonition![
...
<div id="introductions">
{
    names.into_iter().map(|name| {
        ...
        p![
            ...
            " example that lets you test the performance improvements, but here is rough rundown:",
        ],
        ol![
            li![
                "Go to ",
        ...
        p!["So just at the time of writing this, for 500 components its a x2 increase of speed."],
        ...
        p![
            "Without keys, lets assume you iterate through ",
            code("[\"bob\",\"sam\",\"rob\"]"),
