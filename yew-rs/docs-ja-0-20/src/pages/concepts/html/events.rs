crate::doc_page!("Events", "/ja/docs/concepts/html/events",
    Content::new(vec![
        ...
        p(vec![
            ...
            link("/ja/docs/concepts/function-components/callbacks", vec![code("Callback")]),
...
{ "Click me!" }
        ...
        p(vec![
            ...
            link("/ja/docs/advanced-topics/portals", vec![text("portals")]),
        ...
        ul(vec![
            li(vec![
                ...
                link("/ja/docs/concepts/function-components/node-refs", vec![code("NodeRef")]),
