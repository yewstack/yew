crate::doc_page!("HTML", "/ja/docs/concepts/html",
    Content::new(vec![
        p![
            "The ",
            code("html!"),
        ...
        ol![
            ...
            li![
                "The ",
                code("html!"),
                " macro will make all tag names lower case. To use upper case characters (which are required for some SVG elements) use ",
                link!["/ja/docs/concepts/html/elements#dynamic-tag-names", "dynamic tag names"],
                ": ",
                code("html! { <@{\"myTag\"}></@> }"),
            ],
        ],
...
<input id="my_input"> // <- MISSING SELF-CLOSE
        ...
        admonition![AdmonitionType::Tip, None,
            p![
                "For convenience, elements which usually require a closing tag are ",
                bold!["allowed"],
...
html! { <my-element ~property="abc" /> };"#),
        ...
        admonition![AdmonitionType::Note, Some("What classifies as a literal"),
            p![
                ...
                " in Rust. Note that ",
                link!["https://users.rust-lang.org/t/why-are-negative-value-literals-expressions/43333", "negative numbers are not literals"],
        ...
        admonition![AdmonitionType::Note, Some("Component properties"),
            p![
                ...
                link!["/ja/docs/concepts/function-components/properties", "Component Properties"],
            ],
        ],
        ...
        admonition![AdmonitionType::Info, None,
            p![
                "Read more at ",
                link!["/ja/docs/concepts/html/lists", "Lists"],
            ],
        ],
...
<p>{ "True case" }</p>
        ...
        admonition![AdmonitionType::Info, None,
            p![
                "Read more at ",
                link!["/ja/docs/concepts/html/conditional-rendering", "Conditional Rendering"],
            ],
        ],
    ])
);
