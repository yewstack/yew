    ...
    Content::new(vec![
        ...
        ol(vec![
            ...
            li(vec![
                ...
                link("/ja/docs/concepts/html/elements#dynamic-tag-names", vec![text("dynamic tag names")]),
                text(": "),
                code("html! { <@{\"myTag\"}></@> }"),
            ]),
        ]),
...
html! { <my-element ~property="abc" /> };"#),
        ...
        admonition(AdmonitionType::Note, Some("What classifies as a literal"), vec![
            p(vec![
                ...
                link("https://users.rust-lang.org/t/why-are-negative-value-literals-expressions/43333", vec![text("negative numbers are not literals")]),
        ...
        admonition(AdmonitionType::Note, Some("Component properties"), vec![
            p(vec![
                ...
                link("/ja/docs/concepts/function-components/properties", vec![text("Component Properties")]),
            ]),
        ]),
        ...
        admonition(AdmonitionType::Info, None, vec![
            p(vec![
                text("Read more at "),
                link("/ja/docs/concepts/html/lists", vec![text("Lists")]),
            ]),
        ]),
...
<p>{ "True case" }</p>
        ...
        admonition(AdmonitionType::Info, None, vec![
            p(vec![
                text("Read more at "),
                link("/ja/docs/concepts/html/conditional-rendering", vec![text("Conditional Rendering")]),
            ]),
        ]),
    ])
);
