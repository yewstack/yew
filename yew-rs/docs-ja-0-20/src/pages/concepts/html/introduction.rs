    ...
    Content::new(vec![
        ...
        ol![
            ...
            li![
                ...
                link!["/ja/docs/concepts/html/elements#dynamic-tag-names", text("dynamic tag names")],
                text(": "),
                code("html! { <@{\"myTag\"}></@> }"),
            ],
        ],
...
html! { <my-element ~property="abc" /> };"#),
        ...
        admonition![AdmonitionType::Note, Some("Component properties"),
            p![
                ...
                link!["/ja/docs/concepts/function-components/properties", text("Component Properties")],
            ],
        ],
        ...
        admonition![AdmonitionType::Info, None,
            p![
                text("Read more at "),
                link!["/ja/docs/concepts/html/lists", text("Lists")],
            ],
        ],
...
<p>{ "True case" }</p>
        ...
        admonition![AdmonitionType::Info, None,
            p![
                text("Read more at "),
                link!["/ja/docs/concepts/html/conditional-rendering", text("Conditional Rendering")],
            ],
        ],
    ])
);
